...
export default function LoginPage({ navigation }) {
  ...
  //       </Text>
  //       <Text style={{ fontSize: 18 }}>
  //         Docter {item.doctorName} give consultation to {item.patientName}
  //       </Text>
  //     </TouchableOpacity>
  //   );
  // }
  ...
  function getTimeDisplay() {
    const timeString =
      displayMode === "daily"
        ...
        : `${CommonTool.praseTime(from, "DD/MM/YY")} - ${CommonTool.praseTime(
            to,
            "DD/MM/YY"
          )}`;
    return (
  ...
  return (
    <View style={styles.container}>
      {/* <ConsultationModel
        modalVisible={enlargeViewVisible}
        content={recordList[enlargeIdx]}
        onClose={() => {
          setEnlargeViewVisible(false);
        }}
      /> */}
      <Text style={{ fontSize: 22, marginBottom: 20, color: "white" }}>
        {clinicName} Consultation Record
      </Text>
      <View
        style={{
          flexDirection: "row",
      ...
      >
        {Platform.OS === "android" ? (
          ...
          <View style={{ flexDirection: "row" }}>
            <Text
              style={{ color: displayMode === "daily" ? "red" : "white" }}
              onPress={() => {
            ...
            <Text
              style={{ color: displayMode === "weekly" ? "red" : "white" }}
              onPress={() => {
            ...
            <Text style={{ color: "white" }}> | </Text>
            <Text
              style={{ color: displayMode === "monthly" ? "red" : "white" }}
              onPress={() => {
